...
export function Register() {
  const [form, setForm] = useState({ name: "", email: "", password: "", college: "", graduationYear: "" });
  ...
  return (
    <div className="min-h-screen bg-surface-0 flex items-center justify-center p-4">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-accent-purple/8 rounded-full blur-[120px]" />
      </div>
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="relative w-full max-w-md">
        ...
        <div className="bg-surface-2 border border-border rounded-2xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-text-muted">Start your placement journey today</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" required className="input pl-9" placeholder=""
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type={show ? "text" : "password"} required className="input pl-9 pr-9"
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="block text-sm font-medium text-text-secondary mb-1.5">College (optional)</label>
                <div className="relative">
                  <GraduationCap className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-text-muted" />
                  <input type="text" className="input pl-9" placeholder="VIT, BITS..."
                    value={form.college} onChange={set("college")} />
                </div>
              </div>
              <div>
                <label className="block text-sm font-medium text-text-secondary mb-1.5">Grad Year</label>
                <input type="number" className="input" placeholder="2025"
                  min="2020" max="2030" value={form.graduationYear} onChange={set("graduationYear")} />
              </div>
            </div>
